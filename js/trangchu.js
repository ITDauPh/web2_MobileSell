window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('NỔI BẬT', black, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('SẢN PHẨM MỚI', black, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('TRẢ GÓP 0%', black, ['promo=tragop', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIÁ SALE ƯU ĐÃI', black, ['promo=giareonline', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('GIẢM GIÁ LỚN', black, ['promo=giamgia'], soLuong, div);
		addKhungSanPham('ĐIỆN THOẠI GIÁ RẺ', black, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
...
function addKhungSanPham(tenKhung, color, filter, len, ele) {
	...
	var gradient = `background: linear-gradient(225deg, transparent 16px, #333 0) top right, linear-gradient(314deg, transparent 16px, #333 0) bottom right;`
